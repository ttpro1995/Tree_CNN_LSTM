...
public class DependencyParse {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (!props.containsKey("relpath")||
        !props.containsKey("tokpath") ||
        !props.containsKey("parentpath") || 
        !props.containsKey("relpath"))  {
      System.err.println(
        "usage: java DependencyParse -tokenize - -tokpath <tokpath> -parentpath <parentpath> -relpath <relpath> -tagpath <tagpath>");
      System.exit(1);
    }
    ...
    while (stdin.hasNextLine()) {
      ...
      for (TaggedWord tagw : tagged){
          sb.append(tagw.tag());
          sb.append(' ');
      }
      sb.append('\n');
      tagWriter.write(sb.toString());
